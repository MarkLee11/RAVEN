    ...
    >
      ...
      <div className="px-4 pt-4 space-y-6">
        ...
        <div className="flex justify-center">
          <Link to="/submit" state={{ venueId: club.id, venueName: club.name }} className="cta" style={{ color: '#131313' }} aria-label="Spill">
              ...
              {reviews.length > REVIEWS_PER_PAGE && (
                <div className="flex items-center justify-between pt-2">
                  <button
                    ...
                    className="min-h-11 px-4 py-2 text-sm bg-raven text-berlin-black rounded-md disabled:opacity-40 tap-fast"
                  >
                    Previous
                  </button>
                  <span className="text-xs text-ash">
